"""
routers/variants.py — Варианты товаров, штрих-коды, POS, склад.

Исправление: в оригинальном main.py декоратор @app.post("/variants/sync")
был применён к list_variants вместо variants_sync. Здесь это исправлено —
маршруты зарегистрированы корректно.
"""
import uuid
import json
import logging
